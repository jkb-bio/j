...
function openSocial(type) {
  ...
  switch (type) {
    case 'twitter':
      url = 'https://www.roblox.com/users/2389744133/profile';
      break;

      case 'discord':
        url = 'https://www.discord.com/users/984039157305335819';
        break;
        case 'github':
        url = 'https://www.github.com/eyesdev';
        break;  
  }
